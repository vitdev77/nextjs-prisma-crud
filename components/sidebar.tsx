                    ...
                    {group.items.map((item, index) => (
                      <SidebarMenuItem key={item.name} className="relative">
                        ...
                        <SidebarMenuButton
                          ...
                          className="data-[active=true]:bg-accent data-[active=true]:border-accent 3xl:fixed:w-full 3xl:fixed:max-w-48 relative h-6.5 w-fit cursor-pointer overflow-visible border border-transparent text-[0.8rem] font-normal after:absolute after:inset-x-0 after:-inset-y-1 after:z-0 after:rounded-md"
