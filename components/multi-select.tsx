        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "border-input dark:bg-input/30 flex h-auto items-center justify-between rounded-lg border bg-inherit px-2 py-1.25 hover:bg-inherit [&_svg]:pointer-events-auto",
                ...
                <div className="flex w-full items-center justify-between">
                    ...
                    {selectedValues
                      ...
                      .map((value) => {
                        ...
                        return (
                          <Badge
                            key={value}
                            className="bg-card text-primary border-input m-0 h-auto w-full justify-between rounded-sm border border-dashed p-2"
                            style={{
                              ...badgeStyle,
                              animationDuration: `${
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className="text-muted-foreground hover:text-foreground focus:ring-ring mx-2 flex h-4 w-4 cursor-pointer items-center justify-center rounded-lg focus:ring-2 focus:ring-offset-1 focus:outline-none"
                    >
                      <HugeiconsIcon
                        icon={Cancel01Icon}
                        strokeWidth={2}
                    ...
                    <HugeiconsIcon
                      icon={UnfoldMoreIcon}
                      strokeWidth={2}
                      className="text-muted-foreground ml-2 h-4 cursor-pointer"
                      aria-hidden="true"
                    />
                  </div>
                </div>
          ...
          <PopoverContent
            ...
            className={cn(
              ...
              screenSize === "desktop" && "min-w-85.25",
              popoverClassName,
            )}
            style={{
